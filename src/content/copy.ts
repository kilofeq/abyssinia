...
export const pl: Copy = {
  ...
  reserve: {
    ...
    lead: 'Najprościej zadzwonić. Możesz też napisać — odpiszemy z potwierdzeniem.',
    callTitle: 'Telefon',
    groupNote: 'Grupy od {n} osób prosimy o telefon.',
    formTitle: 'Rezerwacja e-mail',
...
export const en: Copy = {
  ...
  reserve: {
    ...
    title: 'Book a table',
    lead: 'Calling is simplest. You can also write — we will reply to confirm.',
    callTitle: 'Phone',
    groupNote: 'For parties of {n} or more, please call.',
    formTitle: 'Email reservation',
    name: 'Full name',
    namePlaceholder: 'Jan Kowalski',
    email: 'Email',
    phone: 'Phone',
